...
C_SRCDIRS   := $(LIBDIRS) $(EXDIRS) $(TESTSDIRS) $(FILEIODIR) $(TIMEDIR) $(STREAMDUMPDIR) $(UNITBENCH_DIRS) $(CUSTOMPARSERSDIR) $(CSVDIR) $(JSONDIR) $(PROFILES_SDDL_DIR) $(PARQUETDIR) $(CLI_DIRS) $(ML_SELECTOR_DIR)
ASM_SRCDIRS := $(LIBDIRS)
CXX_SRCDIRS := $(CLIDIRS) $(ARGDIR) $(TESTSDIRS) $(FILEIODIR) $(TIMEDIR) $(LOGGERDIR) $(CUSTOMPARSERSDIR) $(CSVDIR) $(JSONDIR)  $(PROFILES_SDDL_DIR) $(PARQUETDIR) $(SHARED_COMPONENTSDIR) $(VISUALIZER_CPPDIR) $(IODIR) $(ZLCPP_DIRS) $(ZLCPP_TEST_DIR) $(TRAINING_DIRS) $(TRAINING_TEST_DIRS) $(SDDL_COMPILER_DIR) $(SDDL_COMPILER_TESTS_DIR) $(SDDL2_COMPILER_DIR) $(SDDL2_COMPILER_TESTS_DIR) $(CLI_DIRS) $(CLI_TEST_DIRS) $(ML_SELECTOR_DIR) $(ML_SELECTOR_TESTS_DIR)
